...
public class TagAdapterTest {
  ...
  public void test_TagBooleanAdapter() throws IOException {
    ...
    // write - should write a single byte 0 for false, 1 for true
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagBoolean.class).write(tagTrue, out);
      TestUtil.EXT_REGISTRY.getAdapterFor(TagBoolean.class).write(tagFalse, out);
    ...
    // read - should read a name and a single byte
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagBoolean tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagBoolean.class).read(null, getInputStream(bais));
    ...
    // read - should read only a single byte
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagBoolean tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagBoolean.class).read(new TagList(TagBoolean.class), getInputStream(bais));
  ...
  public void test_TagBooleanArrayAdapter() throws IOException {
    ...
    // booleans are encoded in a single byte
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagBooleanArray.class).write(tag, out);
    ...
    // booleans are encoded in a single byte
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagBooleanArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagBooleanArray.class).read(null, getInputStream(bais));
    ...
    // booleans are encoded in a single byte
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagBooleanArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagBooleanArray.class).read(new TagList(TagBooleanArray.class), getInputStream(bais));
  ...
  public void test_TagDoubleArrayAdapter() throws IOException {
    ...
    // write - should write a single int for length and a series of doubles
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagDoubleArray.class).write(tag, out);
    ...
    // read - should read a name, an int, and a series of doubles
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagDoubleArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagDoubleArray.class).read(null, getInputStream(bais));
    ...
    // read - should read NO name, an int, and a series of doubles
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagDoubleArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagDoubleArray.class).read(new TagList(TagDoubleArray.class), getInputStream(bais));
  ...
  public void test_TagFloatArrayAdapter() throws IOException {
    ...
    // write - should write a single int for length and a series of floats
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagFloatArray.class).write(tag, out);
    ...
    // read - should read a name, an int, and a series of floats
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagFloatArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagFloatArray.class).read(null, getInputStream(bais));
    ...
    // read - should read NO name, an int, and a series of floats
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagFloatArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagFloatArray.class).read(new TagList(TagFloatArray.class), getInputStream(bais));
  ...
  public void test_TagLongArrayAdapter() throws IOException {
    ...
    // write - should write a single int for length and a series of longs
    {
      ...
      TagLongArray tag = new TagLongArray("tagName", new long[] { 25876468343L, 68638465486L, 13898436544L, 88989835355L });
      TestUtil.EXT_REGISTRY.getAdapterFor(TagLongArray.class).write(tag, out);
    ...
    // read - should read a name, an int, and a series of longs
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagLongArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagLongArray.class).read(null, getInputStream(bais));
    ...
    // read - should read NO name, an int, and a series of longs
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagLongArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagLongArray.class).read(new TagList(TagLongArray.class), getInputStream(bais));
  ...
  public void test_TagShortArrayAdapter() throws IOException {
    ...
    // write - should write a single int for length and a series of shorts
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagShortArray.class).write(tag, out);
    ...
    // read - should read a name, an int, and a series of shorts
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagShortArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagShortArray.class).read(null, getInputStream(bais));
    ...
    // read - should read NO name, an int, and a series of shorts
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagShortArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagShortArray.class).read(new TagList(TagShortArray.class), getInputStream(bais));
  ...
  public void test_TagStringArrayAdapter() throws IOException {
    ...
    // write - should write a single int for length and a series of shorts
    {
      ...
      TestUtil.EXT_REGISTRY.getAdapterFor(TagStringArray.class).write(tag, out);
    ...
    // read - should read a name, an int, and a series of shorts
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagStringArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagStringArray.class).read(null, getInputStream(bais));
    ...
    // read - should read NO name, an int, and a series of shorts
    {
      ...
      ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
      TagStringArray tag = TestUtil.EXT_REGISTRY.getAdapterFor(TagStringArray.class).read(new TagList(TagStringArray.class), getInputStream(bais));
